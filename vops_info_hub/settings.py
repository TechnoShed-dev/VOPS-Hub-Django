"""
Django settings for vops_info_hub project.
...
SECRET_KEY = 'django-insecure-ugpl_ot*6vz8%gr*+a_)%m!i!nj)&2nby$!2%79v_#pi(sf6*l'
...
ROOT_URLCONF = 'vops_info_hub.urls'
...
WSGI_APPLICATION = 'vops_info_hub.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'assets', # This tells Django to look in your VOPS-Hub/assets folder
]
